...
from vbot.constants import ABS_MAX_EMBED_CHARACTERS, PREF_MAX_EMBED_CHARACTERS, EmbedColor
...
async def present_embed(  # noqa: PLR0913
    ...
    *,
    ...
    Args:
        ...
        file (discord.File, optional): The file to send with the embed. Defaults to None.
    ...
    return await ctx.respond(**respond_kwargs)  # type: ignore [call-overload]
